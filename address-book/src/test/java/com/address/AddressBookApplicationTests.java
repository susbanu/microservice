...
class AddressBookApplicationTests {
	...
	class SaveAddressTest {
		...
		void testSaveAddress() {
			...
			AddressDto addressDto = new AddressDto("Raj1", "chavan1", "345 street", "Nagpur", "MH", "211089");
		...
		void testSaveAddressWithSameFirstAndLastName() {
			...
			AddressDto addressDto = new AddressDto("Raj1", "chavan1", "345 street1", "Nagpur1", "MH1", "2110891");

...
import com.spring.microservices.currencyconversionservice.proxy.CurrencyExchangeProxyClient;

@RestController
public class CurrencyConversionController {

	@Autowired
	private CurrencyExchangeProxyClient currencyExchangeProxyClient;
	...
	public CurrencyConversion calculateCurrencyConversionFeign(@PathVariable String from, @PathVariable String to,
		...
		CurrencyConversion currencyConversion = currencyExchangeProxyClient.retrieveExchangeValue(from, to);
		return new CurrencyConversion(currencyConversion.getId(), from, to, quantity,
				currencyConversion.getConversionMultiple(),
